        ...
        <div className="text-sm text-muted mb-2">Create Room</div>
          ...
          <div className="relative w-28">
            <select
              id={capId}
              defaultValue={2}
              className="w-full px-3 py-2 pr-8 rounded-lg control border appearance-none"
              aria-label="Capacity"
            >
            ...
            <span className="pointer-events-none absolute inset-y-0 right-2 flex items-center text-muted">▾</span>
          </div>
          <div className="relative w-36">
            <select id={modeId} defaultValue="classic" className="w-full px-3 py-2 pr-8 rounded-lg control border appearance-none">
